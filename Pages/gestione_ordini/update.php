    ...
    <div class="center-container">
        ...
        <div class="card animate-fade-in">
            ...
            <div style="color: var(--color-text-muted);">
                <p><strong>Username:</strong> <?= htmlspecialchars($ordine["username"]) ?></p>
                <p><strong>Email:</strong> <?= htmlspecialchars($ordine["email"]) ?></p>
                <p><strong>Ruolo:</strong> <?= htmlspecialchars($ordine["ruolo"]) ?></p>
            </div>
        </div>
        ...
        <!-- MODIFICA ORDINE -->
        <div class="card animate-fade-in">
            <h3>Modifica Dettagli Ordine</h3>
            <form method="POST">
                ...
                <div class="flex flex-col gap-2 mt-4">
                    ...
                    <button type="submit" name="delete" class="btn btn-danger w-full"
